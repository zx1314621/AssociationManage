		...
		<div class="navbar navbar-inverse navbar-fixed-top" role="banner"> 
			<div class="container"> 
				<div class="navbar-header"> 
					...
					<a class="navbar-brand" href="main.jsp"><h1><img src="images/logo.png" alt="logo"></h1></a> 
				</div> 
	...
	<section id="home">
		...
		<div id="main-carousel" class="carousel slide" data-ride="carousel"> 
			...
			<div class="carousel-inner">
				<div class="item active" style="background-image: url(images/slider/slide3.jpg)"> 
					<div class="carousel-caption"> 
						<div> 
							<h2 class="heading animated bounceInDown">社团管理系统</h2> 
							<p class="animated bounceInUp">更专业</p> 
							<a class="btn btn-default slider-btn animated fadeIn" href="javascript:func1()" >查看活动</a> 
						</div> 
					</div> 
				</div>
				<div class="item" style="background-image: url(images/slider/slide2.jpg)"> 
					<div class="carousel-caption"> <div> 
						<h2 class="heading animated bounceInDown">社团管理系统</h2> 
						<p class="animated bounceInUp">更杰出 </p> <a class="btn btn-default slider-btn animated fadeIn" href="javascript:func1()" >查看活动</a> 
					</div> 
				</div> 
			</div> 
			<div class="item" style="background-image: url(images/slider/slide1.jpg)"> 
				<div class="carousel-caption"> 
					<div> 
						<h2 class="heading animated bounceInRight">社团管理系统</h2> 
						<p class="animated bounceInLeft">更优秀</p> 
						<a class="btn btn-default slider-btn animated bounceInUp" href="javascript:func1()" >查看活动</a> 
					</div> 
				</div> 
			</div>
		</div><!--/.carousel-inner-->
