...
<tr >
    ...
    <td  bgcolor="#FFFFBB">${asList.id }</td>
    </c:if>
    <c:if test="${asList.activestatus == 1 }">
    <td>${asList.id }</td>
    </c:if>
    <c:if test="${asList.activestatus == 0 }">
    <td bgcolor="#FFFFBB">${asList.asname }</td>
    </c:if>
    <c:if test="${asList.activestatus == 1 }">
    <td>${asList.asname }</td>
    </c:if>
    <c:if test="${asList.activestatus == 0 }">
    <td bgcolor="#FFFFBB">${asList.type }</td>
    </c:if>
    <c:if test="${asList.activestatus == 1 }">
    <td>${asList.type }</td>
    </c:if>
    <c:if test="${asList.activestatus == 0 }">
    <td bgcolor="#FFFFBB">${asList.name}</td>
    </c:if>
    <c:if test="${asList.activestatus == 1 }">
    <td>${asList.name}</td>
    </c:if>
