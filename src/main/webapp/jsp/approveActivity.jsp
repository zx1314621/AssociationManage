...
<form class="layui-form"  id="chooseForm" action="searchActivityManager.action" method="post">
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
 ...
 <table class="layui-table">
  ...
  <tbody>
  <form action = submitActivityRegister.action method = "post">
...
<tr>
    ...
    <td>${activityList.as_name }</td>
      <td><button class="layui-btn layui-btn-normal layui-btn-mini news_del" id="approve" name="approve"  type="submit"  value="${activityList.id}"><i class="layui-icon">&#xe605;</i> 同意</button>
      <button class="layui-btn layui-btn-danger" id="refuse" name="refuse"  type="submit"  value="${activityList.id}"><i class="layui-icon">&#x1006;</i> 拒绝</button></td>  
</tr>
</c:forEach>
</form>
  </tbody>
